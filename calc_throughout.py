...
def build_test_loader(
    ...
    t1 = DSRTestDataset(
        datadir="/home/hostname/hostname-MTRRVideo/data/tissue_real",
    ...
    t2 = TestDataset(
        datadir="/home/hostname/hostname-MTRRVideo/data/hyperK_000",
        fns="/home/hostname/hostname-MTRRVideo/data/hyperK_000_list.txt",
        enable_transforms=False, if_align=True, real=True,
        HW=[img_size, img_size], size=test_size[1]
    )

    t3 = DSRTestDataset(
        datadir="/home/hostname/hostname-RDNet1/dataset/laparoscope_gen",
        fns="/home/hostname/hostname-RDNet1/dataset/laparoscope_gen_index/eval1.txt",
        enable_transforms=False, if_align=True, real=True,
        HW=[img_size, img_size], size=test_size[2]
    )

    voc = VOCJsonDataset(
        "/home/hostname/hostname-RDNet1/dataset/VOC2012",
        "/home/hostname/hostname-RDNet1/dataset/VOC2012/VOC_results_list.json",
        size=test_size[3], enable_transforms=True, HW=[img_size, img_size]
    )

    hk1 = HyperKDataset(
        root="/home/hostname/hostname-MTRRNetv2/data/EndoData",
        json_path="/home/hostname/hostname-MTRRNetv2/data/EndoData/test.json",
